...
## :blush:Step eleven  :( use Kaggel database for detect emotional from face  ):blush:</b>
...
file_video_stream = cv2.VideoCapture('video.mp4')
...
## :blush:Step eleven  :( use Kaggel database and HOG detection for image  ):blush:</b>

<br>

In this program u can detect the emotions from Pictures :
...
image_to_detect = cv2.imread('pic1.jpg')
